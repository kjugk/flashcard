  ...
  return (
    <div>
      ...
      <Container style={{ padding: "16px" }}>
        ...
        <p>
          この利用規約（以下，「本規約」といいます。）は，本サービスの運営者（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス「flashcard」（以下，「本サービス」といいます。）の利用条件を定めるものです。
          登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>

        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第1条（適用）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第3条（ユーザーIDおよびパスワードの管理）" />
          <ol>
            <li>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第5条（本サービスの提供の停止等）" />
          <ol>
            <li>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第6条（利用制限および登録抹消）" />
          <ol>
            <li>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第8条（サービス内容の変更等）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第10条（通知または連絡）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第11条（権利義務の譲渡の禁止）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h2" text="第12条（準拠法・裁判管轄）" />
          <ol>
