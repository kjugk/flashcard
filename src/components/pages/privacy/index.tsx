    ...
    <div>
      ...
      <Container style={{ padding: "16px" }}>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第1条（個人情報について）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第2条（個人情報の取得・収集）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第3条（個人情報の利用目的）" />
          <p>
            運営者は、取得した個人情報を下記の目的の範囲内で適切に利用いたします。
          </p>
          <ol>
            <li>サービス全般の提供のため</li>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第4条（個人情報の第三者提供）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第5条（個人情報の開示・訂正・利用停止）" />
          <p>
        ...
        <section style={{ marginBottom: "2rem" }}>
          <Title tag="h3" text="第6条（プライバシーポリシーの改定）" />
          <ol>
            <li>
